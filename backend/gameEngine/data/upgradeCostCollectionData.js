...
var UpgradeCostCollectionData = /** @class */ (function () {
    function UpgradeCostCollectionData() {
        ...
        var artilleryBotArmor = new Resources(0, 20, 0, 0, 0, 100);
        var artilleryBotAttack = new Resources(0, 20, 0, 0, 0, 100);
        var artilleryBotHitPoints = new Resources(0, 50, 0, 0, 0, 50);
        var artilleryBotSpeed = new Resources(0, 100, 0, 0, 5, 100);
        var attackBotArmor = new Resources(0, 20, 0, 0, 0, 100);
        var attackBotAttack = new Resources(0, 20, 0, 0, 0, 100);
        var attackBotHitPoints = new Resources(0, 50, 0, 0, 0, 50);
        var attackBotSpeed = new Resources(0, 100, 0, 0, 5, 100);
        var raiderBotArmor = new Resources(0, 20, 0, 0, 0, 100);
        var raiderBotAttack = new Resources(0, 20, 0, 0, 0, 100);
        var raiderBotHitPoints = new Resources(50, 0, 0, 0, 0, 50);
        var raiderBotSpeed = new Resources(0, 100, 0, 0, 5, 100);
        var tankBotArmor = new Resources(0, 20, 0, 0, 0, 100);
        var tankBotAttack = new Resources(0, 20, 0, 0, 0, 100);
        var tankBotHitPoints = new Resources(0, 50, 0, 0, 0, 50);
        var tankBotSpeed = new Resources(0, 100, 0, 0, 5, 100);

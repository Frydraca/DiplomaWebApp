module.exports = function () {
  return function (req, res, next) {
    ...
    if (res.locals.game.currentTurn <= res.locals.game.commands.length) {
      res.locals.commandsToDo = res.locals.game.commands
        .slice(res.locals.game.currentTurn)
        .flat();
      console.log(res.locals.commandsToDo);
      ...
      res.locals.game.currentCommandNumber = res.locals.game.commands.flat().length;
